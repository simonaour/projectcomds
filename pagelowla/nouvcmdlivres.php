...
$nbr_pages = isset($_GET['nbr_pages']) ? $_GET['nbr_pages'] : "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt->execute([$idCoum, $etat_comm, $pays_comm,$ville_comm, $NomProre, $adresse_comm, $Tcomm, $Ntele, $idP]);
        ...
        <div class="panel-body">
          <form method="post" action="">
            <div class="form-group">
              <label for="idP">l'id du livre :</label>
              <input type="hidden" value="" name="idP" class="form-control" readonly><?php echo $idP ?>
            </div>
            <br>
            <div class="form-group">
              <label for="NomP">le nom du livre :</label>
              <input disabled type="text" value="<?php echo $NomP ?>" name="NomP" class="form-control">
            </div>
            <br>
            <div class="form-group">
              <label for="nbr_pages">le nombre de pages :</label>
              <input disabled type="text" value="<?php echo $nbr_pages ?>" name="nbr_pages" class="form-control">
            </div>
            <br>
