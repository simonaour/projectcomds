...
<li class="nav-item">
  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="addnewmontres.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add new Montre</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../pagelowla/index.php">Home</a></li>
          <li class="breadcrumb-item">Forms</li>
          <li class="breadcrumb-item active">Add New Montre</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container">
        <div class="panel panel-primary margetop ">
            ...
            <form method="post" action="../pagelowla/insertmontre.php" >
                
           
                    <div class="form-group">
                        <label for="NomP">Nom de la montre</label>
                        <input  type="text" name="NomP" placeholder="Entrer le nom de la montre" class="form-control">
                    </div>
                    <br>
                    ...
                    &nbsp;
                    <input disabled  type="text" name="nomC" value="Montres"  class="form-control">
                    &nbsp;
                    <br>
                    <label for="prixP">Le prix de la montre </label>
                    <br>
                    <input class="form-control" type="text" name="prixP" placeholder="entrer le prix">
                    <br>
                    <label for="poids">Poids</label>
                    <br>
                    <input style="width:80px" class="form-control" type="number" name="poids" placeholder="entrer le poid de la montre">
                    <br>
                    <label for="Matièere">Matiere</label>
                    <br>
                    <input  class="form-control" type="text" name="Matièere" placeholder="entrer la matiere de la montre">
                    <br>
                
                    <label for="description_du_produit">Description de la montre</label>
                    <br>
                    <input  class="form-control" type="text" name="description_du_produit" placeholder="entrer la description de la montre">
                    <br>
