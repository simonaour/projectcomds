...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $Matièere = isset($_GET['Matièere']) ? $_GET['Matièere'] : "";
  


  $stmt = $pdo->prepare("INSERT INTO commandes(id_commande,etat_comm ,pays_comm ,ville_comm, nom_proprietaire_commande,adresse_comm,total_commande,numero_telephone,poids,Matièere,id_produit) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
  $stmt->execute([$idCoum, $etat_comm, $pays_comm,$ville_comm, $NomProre, $adresse_comm, $Tcomm, $Ntele,$poids,$Matièere, $idP]);


  header('Location: commandatmontres.php');
        ...
        <div class="panel-body">
          <form method="post" action="">
            <div class="form-group">
              <label for="idP">l'id de la montre :</label>
              <input type="hidden" value="" name="idP" class="form-control" readonly><?php echo $idP ?>
            </div>
            <br>
            <div class="form-group">
              <label for="NomP">le nom de la montre :</label>
            ...
            <div class="form-group">
              ...
              <input type="number" name="poids" placeholder="Entrer le poids" class="form-control">
            </div>
            <br>
            <div class="form-group">
              <br>
              <label for="Matièere">la matiere :</label>
              <input type="text" name="Matièere" placeholder="Entrer la matiere" class="form-control">
            </div>
            <br>
            <div class="form-group">
