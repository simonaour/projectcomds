...
if ($nomC == "all") {
  $requete = "SELECT * FROM Produits WHERE nom_produit LIKE '%$NomP%' AND catégorie_produit LIKE 'Sabots' order BY id_produit ";

} elseif ($NomP == "" ) {
  $requete = "SELECT * FROM Produits WHERE catégorie_produit LIKE '$nomC'  AND catégorie_produit LIKE 'Sabots' order BY id_produit";
...
<li class="nav-item">
  ...
  <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li>
      <a href="produissabot.php" class="active">
    ...
    <div class="container">
      ...
      <div class="panel panel-primary ">
        ...
        <div class="card top-selling overflow-auto">
          <br><br>
          <?php
          $requetepl = "SELECT COUNT(id_produit) AS count_produits FROM produits WHERE catégorie_produit LIKE 'Sabots'";
              ...
              <tbody>
                ...
                <?php while ($produits = $resultat->fetch()) { ?>
                  <tr>
                    ...
                    <td>
                      <?php echo $produits['pointure'] ?>
                    </td>
                    <td>
                      <a href="nouvcmdsabot.php?idP=<?php echo $produits['id_produit'] ?>&NomP=<?php echo $produits['nom_produit'] ?>&pointure=<?php echo $produits['pointure'] ?>"
