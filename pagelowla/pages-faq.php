        ...
        <div class="col-lg-6">
          ...
          <div class="card basic">
            <div class="card-body">
              ...
              <div>
                <h6>1.  Quelle est la description de l'entreprise ?</h6>
                <p>Créé en mai 2012, PrixVado est le site e-commerce N° 1 au Maroc dont l'objectif est la gestion de vos commandes.</p>
              </div>

              <div class="pt-2">
                <h6>2.  Quelle est l'Histoire de PrixVado ?</h6>
                <p>La plateforme de PrixVado est un marché en ligne qui met en relation des vendeurs et des acheteurs, en mettant à leur disposition un service logistique, permettant l'expédition et la livraison des colis en plus d'un service de paiement3. En 2022, plus de 100,000 vendeurs proposent une large gamme de produits et de services à la demande4: appareils électroménagers et électroniques, mode, jouets pour enfants, mais aussi des services tels des réservations d'hôtels ou d’avion, et la livraison de repas. Jumia est notamment qualifié d'« Alibaba africain » ou d'« Amazon africain ».</p>
              </div>
