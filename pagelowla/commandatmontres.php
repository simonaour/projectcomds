...
if (isset($_SESSION['utilisateurs'])) {
  ...
  WHERE p.catégorie_produit = 'montres' 
...
<li class="nav-item">
  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li>
      <a href="commandatmontres.php" class="active">
                    ...
                    <form method="get" action="commandat.php" class="form-inline">
                        ...
                        <div class="panel panel-primary ">
                            ...
                            <div class="card top-selling overflow-auto">
                                ...
                                <?php
                                $requetepl = "SELECT COUNT(c.id_commande) AS count_commandes,p.catégorie_produit FROM commandes c , produits p WHERE c.id_produit=p.id_produit AND p.catégorie_produit = 'Montres'";
