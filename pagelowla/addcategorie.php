...
<head>
  ...
  <title>PrixVado / Add Catégorie</title>
  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="cat-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="addcategorie.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add catégorie</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container">
      <div class="panel panel-primary margetop ">
        ...
        <div class="panel-body">
          <form method="post" action="../pages/insertProduit.php">
            <pre
              class="alert alert-danger">POUR POUVOIR AJOUTER UNE NOUVELLE CATEGORIE , TU DOIS AJOUTER UN PRODUIT A CETTE CATEGORIE </pre>
            ...
            <div class="form-group">
              ...
              <br>
              <label for="description_du_produit">La description du produit :</label>
              <br>
              <input class="form-control" type="text" name="description_du_produit" placeholder="entrer la description">
