  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="addnewsabot.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Sabot</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container">
        <div class="panel panel-primary margetop ">
            ...
            <form method="post" action="../pagelowla/insertsabot.php" >
                
           
                    <div class="form-group">
                        <label for="NomP">Nom du sabot</label>
                        <input  type="text" name="NomP" placeholder="Entrer le nom du sabot" class="form-control">
                    </div>
                    <br>
                    ...
                    &nbsp;
                    <input disabled  type="text" name="nomC" value="Sabots"  class="form-control">
                    &nbsp;
                    <br>
                    <label for="prixP">Le prix du sabot </label>
                    <br>
                    ...
                    <label for="description_du_produit">Description du sabot</label>
                    <br>
                    <input  class="form-control" type="text" name="description_du_produit" placeholder="entrer la description du sabot">
                    <br>
