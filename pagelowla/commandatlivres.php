...
if (isset($_SESSION['utilisateurs'])) {
    ...
    FROM produits p, commandes c WHERE p.id_produit = c.id_produit AND p.catégorie_produit = 'Livres'   order by id_commande";
...
<li class="nav-item">
  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    <li>
      <a href="commandatlivres.php" class="active">
            ...
            <div class="panel panel-success margetop">
                            ...
                            <div class="panel panel-primary ">
                                ...
                                <div class="card top-selling overflow-auto">
                                    ...
                                    <?php
                                    $requetepl = "SELECT COUNT(c.id_commande) AS count_commandes,p.catégorie_produit FROM commandes c , produits p WHERE c.id_produit=p.id_produit AND p.catégorie_produit = 'Livres'";
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <h7 class="btn btn-primary">
                                            ...
                                            <h7 class="badge">
                                                <?php echo $commandes['count_commandes']; ?>
                                            </h7>
                                        </h7>
                                    </div>
                                                        ...
                                                        <?php if ($_SESSION['utilisateurs']['role_user'] == 'ADMIN') { ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="../pages/deleteCommande.php?idCoum=<?php echo $commandes['id_commande'] ?>"
                                                                    ...
                                                                    <img class="imghorloge"
                                                                        src="../images/icons8-poubelle-50.png" alt="#"></a>
                                                                </a>
                                                            </td>
                                                        <?php } ?>
