            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="../pages/insertUser.php" class="row g-3 needs-validation" novalidate>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="login_user" autocomplete="off" placeholder="Entrer votre login"
                            minlength="4" class="form-control" required>
                    </div>
<br>
