  ...
  <ul id="commandes-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="addnewlivre.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Livre</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="container">
        <div class="panel panel-primary margetop ">
            ...
            <form method="post" action="../pagelowla/insertlivres.php" >
                
           
                    <div class="form-group">
                        <label for="NomP">Nom du livre</label>
                        <input  type="text" name="NomP" placeholder="Entrer le nom du livre" class="form-control">
                    </div>
                    <br>
                    ...
                    &nbsp;
                    <input disabled  type="text" name="nomC" value="Livres" placeholder="Entrer le nom du livre" class="form-control">
                    &nbsp;
                    <br>
                    <label for="prixP">Le prix du livre </label>
                    <br>
                    <input class="form-control" type="text" name="prixP" placeholder="entrer le prix">
                    <br>
                    <label for="nbr_pages">Le nombre de pages </label>
                    <br>
                    <input style="width:80px" class="form-control" type="number" name="nbr_pages" placeholder="entrer le nombre de page">
                    <br>
                
                    <label for="description_du_produit">Description du Livre </label>
                    <br>
                    <input  class="form-control" type="text" name="description_du_produit" placeholder="entrer la description du livre">
                    <br>
