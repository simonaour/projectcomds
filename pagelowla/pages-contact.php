          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p> Place Maarif,<br>Casablanca, NY 535022</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Call Us</h3>
                <p>+212 624-993086<br>+212 721-302187</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                <i class="bi bi-envelope"></i>
                <h3>Email Us</h3>
                <p>n.mohamedidriss@gmail.com<br>contact@prixvado.com</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Open Hours</h3>
                <p>Monday-Saturday<br>24h/24h</p>
              </div>
            </div>
          </div>
