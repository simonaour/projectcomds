...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Tous les tables</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../pagelowla/index.php">Home</a></li>
          <li class="breadcrumb-item">Tables</li>
          <li class="breadcrumb-item active">Tous les tables</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card ">
            <div class="card-body">
              <h5 class="card-title">Tous les tables</h5>
                <a href="commandat.php"><button class="btn btn-primary" >Commandes</button></a>
                <br><br>
                <a href="produis.php"><button class="btn btn-warning" >Produits</button></a>
                <br><br>
                <a href="utilisa.php"><button class="btn btn-danger" >Utilisateurs</button></a>
